    ...
    <div class="col-md-12">
        ...
        <nav class="row" style="margin: 0 4px">
            <ol class="breadcrumb radius50">
                ...
                <li class="breadcrumb-item"><span><b>Clients</b></span></li>
            </ol>
        </nav>
        ...
        <div class="" style="margin-top: 50px">
            ...
            <div class="row" >
                <div class="col-md-12">
                    <a href="{{ route('client.create') }}" class="btn btn-orange-border btn-lg btn-sm">New Client</a>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle dataTable no-footer"
                        ...
                        @forelse($users as $user)
                            <tr class="gradeX odd" role="row">
                                ...
                                <td>{{ $user->phone }}</td>
                                <td>
                                    <a href="{{ route('client.show', $user->unid) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i>view</a>
